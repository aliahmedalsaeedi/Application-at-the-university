public class Controller {
    ...
    public boolean addNewStudent(int id, String First_Name, String Last_Name, int registrationYear)
    {
        if (numOfStudent<allStudents.length)
        {
        Student s= new Student(id,First_Name ,Last_Name,registrationYear);
